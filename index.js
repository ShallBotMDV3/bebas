...
console.log(color('\n🐶 YT CHANNEL: - ','silver'))
console.log(color('🐶 GITHUB: FShal ','silver'))
console.log(color('🐶 WA NUMBER: +6282131519891 ','silver'))
console.log(color('  🦄Shall Bot Inc. 2022🦄','mediumseagreen'))
    ...
    console.log(color('🐶', 'cyan'), color('https://wa.me/6182131519891'))
